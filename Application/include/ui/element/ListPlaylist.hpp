#ifndef ELEMENT_LISTPLAYLIST_HPP
#define ELEMENT_LISTPLAYLIST_HPP

#include "Aether/Aether.hpp"

namespace CustomElm {
    class ListPlaylist : public Aether::Element {
        ...
        private:
            ...
            // This works as all ListPlaylist's will only be in the same list
